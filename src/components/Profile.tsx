...
import { experiences } from "../constant/profile";
      ...
      <div className="relative mx-auto w-full max-w-7xl md:px-10">
        <div className="mb-12 md:mb-16 mx-5">
          <div className="min-h-20 md:min-h-22">
            <h2 className="description-panel text-5xl font-semibold font-nb text-right leading-none">
              Definisi dan Pengalaman
            </h2>
          </div>
          <p className="font-helvetica mt-5 font-semibold">
            Lebih dari sekadar daftar pekerjaan, ini adalah rangkuman dari
            setiap tantangan yang saya hadapi dan pelajaran yang saya petik di
            sepanjang jalan
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 md:gap-14 items-start">
          <div className="lg:col-span-2">
            <div className="flex gap-5 ">
              <div className="relative md:w-full ml-6 w-59.25 h-45.5 lg:mx-0  max-w-sm aspect-4/5 rounded-2xl overflow-hidden ring-1 ring-white/15 bg-zinc-900 shadow-2xl">
                <Image
          ...
          <div className="lg:col-span-3 space-y-8">
            <div className="rounded-2xl  p-6 md:p-8 backdrop-blur-sm">
              ...
              <p className="mt-4 text-zinc-300 text-right leading-relaxed text-base md:text-lg font-helvetica">
                Saya merupakan seorang mahasiswa yang sedang mengembangkan skill
                sebagai developer. Saya terus belajar untuk bisa menggapai suatu
                keinginan saya dan bisa menjadi orang yang sukses
              </p>
            </div>
                    ...
                    <article
                      ...
                      style={{
                        ...
                        transitionDelay: openExperience
                          ? `${index * 70}ms`
                          : `${(experiences.length - 1 - index) * 45}ms`,
                      }}
                    >
                      <p className="text-xs uppercase tracking-[0.14em] text-zinc-500 font-helvetica">
                        {experience.period}
                      </p>
